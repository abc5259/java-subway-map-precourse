...
- [x] 초기 지하철 역과 노선 세팅을 진행한다.
- [x] 메뉴 선택 화면을 보여준다.
- [x] 특정 메뉴를 선택할 수 있다.
- [x] 지하철 역을 등록한다.
    - [x] 예외1. 역 이름은 2글자 이상이어야 함
    - [x] 예외2. 이미 등록된 이름은 사용 불가능
- [x] 자하철 역을 삭제한다.
    - [x] 예외1. 해당 역이 없는 경우
    - [x] 예외2. 노선에 등록된 역인 경우 삭제 불가능
- [x] 지하철 역 목록을 조회한다.
- [x] 지하철 노선을 등록한다.
    - [x] 예외1. 노선 이름은 2글자 이상
    - [x] 예외2. 이미 등록된 이름이라면 예외
- [x] 지하철 노선을 삭제한다.
    - [x] 예외1. 없는 노선을 입력하는 경우
- [x] 지하철 노선 목록 조회
- [x] 지하철 노선 목록 조회
- [x] 지하철 노선에 구간 추가 기능
- [x] 지하철 구간 삭제 기능
    - [x] 예외1. 삭제하려는 노선의 역 개수가 2개 이하일 경우 삭제 불가능
